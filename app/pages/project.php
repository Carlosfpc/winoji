...
<div class="card mb-8">
    ...
    <div class="form-row">
        <input type="text" id="new-project-name" placeholder="Nombre del proyecto"
            class="form-input flex-1" style="min-width:180px;">
        <input type="text" id="new-project-desc" placeholder="Descripción (opcional)"
...
<div class="card mb-8">
    ...
    <div class="form-row">
        <div style="flex:2;min-width:130px;">
            ...
            <input type="text" id="new-type-name" placeholder="ej. Epic"
                class="form-input w-full">
        </div>
        <div style="flex:3;min-width:160px;">
            <label class="form-label">Descripción (opcional)</label>
            <input type="text" id="new-type-desc" placeholder="Qué representa este tipo"
                class="form-input w-full">
        </div>
        <div class="flex-shrink-0 flex items-center gap-1" style="align-self:flex-end;padding-bottom:0.05rem;">
            <input type="color" id="new-type-color" value="#6b7280"
                title="Color"
...
<div class="card mb-6">
    ...
    <div class="form-group">
        ...
        <input type="text" id="gh-repo-name" placeholder="acme/mi-proyecto"
            class="form-input w-full">
    </div>
    <div class="form-group mb-4">
        <label class="form-label">Token de Acceso Personal</label>
        <input type="password" id="gh-repo-token" placeholder="ghp_..."
            class="form-input w-full">
        <p class="form-hint">
...
<div class="card mt-6">
    ...
    <div id="template-form" style="display:none;border-top:1px solid var(--border);padding-top:1rem;margin-top:1rem;">
        <input type="hidden" id="tpl-id">
        <div class="flex-col gap-2">
            <input type="text" id="tpl-name" placeholder="Nombre de la plantilla *" class="form-input w-full">
            <input type="text" id="tpl-title" placeholder="Título pre-rellenado (opcional)" class="form-input w-full">
    ...
    card.innerHTML = `
        <div>
            <div class="flex items-center gap-3 flex-wrap mb-4">
                ...
                <a href="${escapeHtml(data.url)}" target="_blank" class="btn btn-secondary btn-sm ml-auto flex-shrink-0">Ver en SonarQube &#8599;</a>
            </div>
