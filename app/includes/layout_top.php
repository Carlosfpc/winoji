...
<head>
    ...
    <title><?= htmlspecialchars($page_title ?? 'Team App') ?></title>
...
<div id="confirm-modal" class="modal hidden">
    <div class="modal-box" style="max-width:420px;">
        ...
        <div id="confirm-word-check" class="confirm-word-box" style="display:none;">
            <p class="text-sm text-muted mb-2">Escribe <strong class="text-danger font-mono">ELIMINAR</strong> para confirmar:</p>
...
<div class="app-root">
    ...
    <header class="app-header">
        <button id="sidebar-toggle" class="btn-sidebar-toggle flex-shrink-0" style="display:none;">&#9776;</button>
